...
import (
	...
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/config"
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/internal/blockchain"
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/alphabet"
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/audit"
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/balance"
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/container"
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/governance"
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/neofs"
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/netmap"
	nodevalidator "github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/netmap/nodevalidation"
	availabilityvalidator "github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/netmap/nodevalidation/availability"
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/netmap/nodevalidation/privatedomains"
	statevalidation "github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/netmap/nodevalidation/state"
	addrvalidator "github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/netmap/nodevalidation/structure"
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/reputation"
	"github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/settlement"
	auditSettlement "github.com/epicchainlabs/epicchain-node/pkg/innerring/processors/settlement/audit"
	timerEvent "github.com/epicchainlabs/epicchain-node/pkg/innerring/timers"
	...
	balanceClient "github.com/epicchainlabs/epicchain-node/pkg/morph/client/balance"
	cntClient "github.com/epicchainlabs/epicchain-node/pkg/morph/client/container"
	neofsClient "github.com/epicchainlabs/epicchain-node/pkg/morph/client/neofs"
	...
	"github.com/epicchainlabs/epicchain-node/pkg/network/cache"
	audittask "github.com/epicchainlabs/epicchain-node/pkg/services/audit/taskmanager"
	control "github.com/epicchainlabs/epicchain-node/pkg/services/control/ir"
	controlsrv "github.com/epicchainlabs/epicchain-node/pkg/services/control/ir/server"
...
func New(ctx context.Context, log *zap.Logger, cfg *viper.Viper, errChan chan<- error) (*Server, error) {
	...
	if isLocalConsensus {
		...
		// don't move this code area within current function
		{
			...
			// to separate the stages of construction and launch. Track epicchain-node#2294
