...
import (
	...
	morphClient "github.com/epicchainlabs/epicchain-node/pkg/morph/client"
	cntClient "github.com/epicchainlabs/epicchain-node/pkg/morph/client/container"
	objectTransportGRPC "github.com/epicchainlabs/epicchain-node/pkg/network/transport/object/grpc"
	objectService "github.com/epicchainlabs/epicchain-node/pkg/services/object"
	"github.com/epicchainlabs/epicchain-node/pkg/services/object/acl"
	...
	deletesvcV2 "github.com/epicchainlabs/epicchain-node/pkg/services/object/delete/v2"
	getsvc "github.com/epicchainlabs/epicchain-node/pkg/services/object/get"
	getsvcV2 "github.com/epicchainlabs/epicchain-node/pkg/services/object/get/v2"
	...
	putsvcV2 "github.com/epicchainlabs/epicchain-node/pkg/services/object/put/v2"
	searchsvc "github.com/epicchainlabs/epicchain-node/pkg/services/object/search"
	searchsvcV2 "github.com/epicchainlabs/epicchain-node/pkg/services/object/search/v2"
	"github.com/epicchainlabs/epicchain-node/pkg/services/object/split"
	"github.com/epicchainlabs/epicchain-node/pkg/services/object/tombstone"
...
func (c *reputationClient) ObjectPutInit(ctx context.Context, hdr objectSDK.Object, signer user.Signer, prm client.PrmObjectPutInit) (client.ObjectWriter, error) {
	...
	// FIXME: (epicchain-node#1193) here we submit only initialization errors, writing errors are not processed
	c.submitResult(err)
...
func (c *reputationClient) GetObjectInit(ctx context.Context, containerID cid.ID, objectID oid.ID, signer user.Signer, prm client.PrmObjectGet) (objectSDK.Object, *client.PayloadReader, error) {
	...
	// FIXME: (epicchain-node#1193) here we submit only initialization errors, reading errors are not processed
	c.submitResult(err)
