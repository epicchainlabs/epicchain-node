...
import (
	...
	"github.com/epicchainlabs/epicchain-node/cmd/epicchain-adm/internal/modules/config"
	"github.com/epicchainlabs/epicchain-node/cmd/epicchain-adm/internal/modules/morph"
	"github.com/epicchainlabs/epicchain-node/cmd/epicchain-adm/internal/modules/storagecfg"
...
func init() {
	...
	rootCmd.AddCommand(autocomplete.Command("epicchain-adm"))
