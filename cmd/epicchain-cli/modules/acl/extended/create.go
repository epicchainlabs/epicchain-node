...
import (
	...
	"github.com/epicchainlabs/epicchain-node/cmd/epicchain-cli/modules/util"
...
`,
	Example: `epicchain-cli acl extended create --cid EutHBsdT1YCzHxjCfQHnLPL1vFrkSyLSio4vkphfnEk -f rules.txt --out table.json
epicchain-cli acl extended create --cid EutHBsdT1YCzHxjCfQHnLPL1vFrkSyLSio4vkphfnEk -r 'allow get obj:Key=Value others' -r 'deny put others' -r 'deny put obj:$Object:payloadLength<4096 others' -r 'deny get obj:Quality>=100 others'`,
	Args: cobra.NoArgs,
	Run:  createEACL,
}
